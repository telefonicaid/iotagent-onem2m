...
function loadTemplates(callback) {
    ...
    async.series([
        ...
        async.apply(fs.readFile, path.join(__dirname, '../templates/resourceCreation.xml'), 'utf8'),
        async.apply(fs.readFile, path.join(__dirname, '../templates/subscriptionCreation.xml'), 'utf8')
        ...
        if (error) {
            ...
            templates.resourceCreationTemplate = results[2];
            templates.subscriptionCreationTemplate = results[3];
            callback();
        }
    });
}
