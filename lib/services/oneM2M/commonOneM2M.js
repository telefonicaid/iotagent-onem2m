...
/**
 * Generates a function that extract the attributes from the XML response body of a Create AE operation, adding them to
 * the object passed in the 'initialValue' parameter.
 *
 * @param {Array} fields         List of the attributes to be extracted from the XML.
 * @return {Function}            Function that extracts the selected parameters from an XML body.
 */
