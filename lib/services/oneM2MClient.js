 ...
 * @returns {Object}            Map containing the headers with its names translated to OneM2M short names.
 */
 ...
 *
 * @returns {Function}          Handler for a HTTP AE creation request.
 */
 ...
 *
 * @returns {Function}          Handler for a HTTP AE removal request.
 */
...
/**
 * Initializes the client module, passing the new configuration, and creating the templates.
 *
 * @param {Object} newConfig       Object holding the IOTA configuration.
 */
